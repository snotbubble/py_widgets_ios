...
# copied from Soon Van 'randomecho' : https://gist.github.com/randomecho/5020859
...
(2602, 'OConnor', 'ACT', -35.260, 149.150),
...
(2606, 'OMalley', 'ACT', -35.350, 149.080),
...
(2795, 'OConnell', 'NSW', -33.910, 149.330),
...
newcodes = []
checks = []
for i in nswpostcodes :
	if not i[0] in checks :
		if i[3] != 0.000 and i[4] != 0.000 :
			checks.append(i[0])
			newcodes.append((i[0],i[1],i[3],i[4]))
if len(newcodes) > 0 :
	cdr = os.path.split(os.path.realpath('nswpostcodes.py'))[0]
	cdo = cdr + "/nswpostcodes.csv"
	f = open(cdo,'w')
	for l in newcodes :
		#print(str(l))
		s = ""
